...
typedef struct
{
  ...
  unsigned char HoldFlag;//1 means HoldModifier needs to be changed, 0 means no need to change
  unsigned char HoldModifiers;//contains data to bitwise OR with modifier byte; applied by HOLD command
